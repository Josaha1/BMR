function addFood()
      {
        ...
        document.AddFood.totalRice.value = Math.round(ricetotal-DiffRice1);
        document.AddFood.totalMeet.value = Math.round(Meettotal-DiffMeet1);
        document.AddFood.totalVeg.value = Math.round(Vegtotal-DiffVeg1);
        document.AddFood.totalFriut.value = Math.round(friuttotal-DiffFriut1);
